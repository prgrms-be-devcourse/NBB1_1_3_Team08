...
class ChattingController(
  ...
  fun getParticipation(@PathVariable("roomId") roomId: Long): ResponseEntity<ChatParticipationResponse> {
    val response = chattingQueryService.getParticipation(roomId)
